...
import {isEqual, addClasses, removeClasses, supportsPassive} from '../utils'
...
export default class Tooltip {
	...
	_create(reference, template) {
		...
		if (this.options.autoHide && this.options.trigger.indexOf('hover') !== -1) {
			tooltipNode.addEventListener('mouseenter', (evt) =>
				this._scheduleHide(reference, this.options.delay, this.options, evt),
			)
			tooltipNode.addEventListener('click', (evt) =>
				this._scheduleHide(reference, this.options.delay, this.options, evt),
			)
		}
